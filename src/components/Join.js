	...
	return (
		<div className="join">
			...
			<div className="team-photo">
				...
				<h5><a href="https://forms.gle/hQuP7GFPHm4vso879">General Application Link</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://docs.google.com/forms/d/e/1FAIpQLSc9ZRIBjU8hwW-z_L0Pjw3RmoBVFkoOZhqVcyIuHQQxk-LPsA/viewform?usp=sf_link"> Autonomous R&D Application Link </a></h5>
